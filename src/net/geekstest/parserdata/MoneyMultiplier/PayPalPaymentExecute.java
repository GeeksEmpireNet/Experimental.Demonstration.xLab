...
public class PayPalPaymentExecute {
	public static void main(String[] args) {
		try {
			...
			String accessToken = "A21AAHho7usq0Cv9CKrYjOfBM1aKYt8-KX8DtkcSmkeHar2kp93PXU6_QyWDhlzbXhzKPYG2HIorlqqcpmBzXHSYpq46_MGqA";
			String PayerID = "84CE4GE6USJHW";//From PayPayl Server 
			String paymentId = "PAYID-LWI4JNQ2G907621RL552372E";//From PayPayl Server
